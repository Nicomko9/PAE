...
public class JeBizTest {
  ...
  @Test
  public void testGetDayYear() {
    assertEquals(LocalDateTime.now().getYear(), jeBiz1.getDayYear());
  }
  
  @Test
  public void testSetDayYear() {
    jeBiz1.setDayYear(2001);
    assertEquals(2001, jeBiz1.getDayYear());
  }
