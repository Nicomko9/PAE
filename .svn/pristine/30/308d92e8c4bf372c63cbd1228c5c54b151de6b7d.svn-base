...
public interface CompanyDao extends CompanySchema, GenericDao {
  ...
  /**
   * Search for companies that meet at least one of the criteria.
   * 
   * @param criteria the criteria for the search
   * @return a {@link Set} of {@link CompanyDto}
   */
