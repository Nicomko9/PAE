...
public class ParticipationDaoImpl extends AbstractDao implements ParticipationDao {
  ...
  public ParticipationDto create(Participation participation) {
    try {
      ...
      Logger.log("ParticipationDaoImpl", "create",
          "The participation creation failed : " + exception.getMessage(), Logger.ERROR);
      throw new FatalException();
    }
  }
    ...
    try {
      ...
      if (!rs.next()) {
        ...
        Logger.log("ParticipationDaoImpl", "update", "The participation update failed : "
            + "The version number ( " + participation.getVersion()
            + " does not match that of the database", Logger.ERROR);
      ...
      Logger.log("ParticipationDaoImpl", "update",
          "The participation update failed : " + exception.getMessage(), Logger.ERROR);
      throw new FatalException();
    }
  }
  ...
  public List<ParticipationDto> findByYear(int year) {
    ...
    try {
      ...
      Logger.log("ParticipationDaoImpl", "findByYear",
          "The search of participations failed : " + exception.getMessage(), Logger.ERROR);
      throw new FatalException();
    }
  }
  ...
  public ParticipationDto findByYearAndCompany(int year, int companyNumber) {
    ...
    try {
      ...
      Logger.log("ParticipationDaoImpl", "findByYearAndCompany", "The participation was " + "found",
          Logger.SUCCESS);
      rs.close();
      return participation;
    } catch (SQLException exception) {
      Logger.log("ParticipationDaoImpl", "findByYearAndCompany",
          "The search of the participation " + "failed : " + exception.getMessage(), Logger.ERROR);
      throw new FatalException();
    }
  }
  ...
  public List<ParticipationDto> findByCompanyNumber(int companyNumber) {
    ...
    try {
      ...
      Logger.log("ParticipationDaoImpl", "findByCompanyNumber",
          "The search of participations " + "failed : " + exception.getMessage(), Logger.ERROR);
      throw new FatalException();
    }
  }
