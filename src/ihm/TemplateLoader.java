...
class TemplateLoader {
  ...
  private ArrayList<String> jsFiles = new ArrayList<String>() {
    {
      ...
      add("startbootstrap-sb-admin-2-gh-pages/vendor/datatables/js/jquery.dataTables.js");
      add("startbootstrap-sb-admin-2-gh-pages/vendor/datatables-plugins/dataTables.bootstrap.js");
      ...
      add("js/objects/companies.js");
      add("js/objects/contacts.js");
      add("js/objects/participations.js");
  ...
  public void compile() {
    try (Writer writer = new BufferedWriter(
        new OutputStreamWriter(new FileOutputStream("web/index.html"), "utf-8"))) {
      ...
      Logger.log("TemplateLoader", "compile",
          "The compilation was failed : " + exception.getMessage(), Logger.ERROR);
    }
  }

  private void appendJsFiles() throws IOException {
    try (Writer writer = new BufferedWriter(
        new OutputStreamWriter(new FileOutputStream("web/js_appended.js"), "utf-8"))) {
      for (String jsFile : jsFiles) {
        ...
        try {
          reader = new BufferedReader(
              new InputStreamReader(new FileInputStream("web/" + jsFile), "UTF-8"));

          while (null != (str = reader.readLine())) {
            writer.write(str + "\n");
          }
        } catch (Exception exception) {
          Logger.log("TemplateLoader", "appendingJs",
              "Appending failed : " + exception.getMessage(), Logger.ERROR);
        } finally {
          if (reader != null) {
            reader.close();
          }
  ...
  private void loadInnerTemplate(Writer writer, String template) throws IOException {
    ...
    writer.write("<div class=\"container-fluid inner-template\" data-template=\"" + template
        + "\" style=\"display:none\">");
